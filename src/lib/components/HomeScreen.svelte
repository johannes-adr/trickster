...
<div class="min-h-screen bg-zinc-950 text-white flex flex-col items-center justify-center p-6">
  <div class="w-full max-w-sm flex flex-col items-center gap-10">
    <div class="flex flex-col items-center gap-3">
      ...
      <h1 class="text-5xl font-black tracking-tight text-center">Imposter</h1>
    ...
    <div class="w-full flex flex-col gap-3 text-zinc-400 text-sm bg-zinc-900 rounded-2xl p-5">
      <div class="flex gap-3 items-start">
        ...
        <span>Every player gets a secret word — except the imposter</span>
      </div>
      <div class="flex gap-3 items-start">
        <span class="text-xl">🗣️</span>
        <span>Discuss and give clues without revealing the word</span>
      </div>
      <div class="flex gap-3 items-start">
        <span class="text-xl">🗳️</span>
        <span>Vote on who you think is faking it</span>
      </div>
    </div>
